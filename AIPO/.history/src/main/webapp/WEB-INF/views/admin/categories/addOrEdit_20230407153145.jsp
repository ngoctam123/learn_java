    ...
    <main class="container">
        ...
        <section  class="row">
         <div class="col-md-6 offset-md-3 mt-4">
            <form action="${pageContext.request.contextPath}/categories/saveOrUpdate" method="post">
                <div class="card">
                    ...
                    <div class="card-body">
                     <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="categoryId" id="categoryId" aria-describedby="categoryId" placeholder="category id">
                    ...
                    <div class="card-footer text-muted">
                      ...
                      <button class="btn btn-success">List category</button>
