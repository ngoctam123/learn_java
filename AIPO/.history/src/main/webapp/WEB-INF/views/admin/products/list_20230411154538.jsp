              ...
              <div class="card-body">
                    ...
                    <c:forEach items="${products }" var="product" varStatus="loop">
                      <tr>
                        ...
                        <td>
                          ...
                          <a onclick="showConfirmModalDialog(1, 'asd')" data-bs-toggle="modal" data-bs-target="#confirmationId"class="btn btn-outline-danger"><i
                ...
                <script>
                  const showConfirmModalDialog = (id, name) => {
                    ...
                    confirmationId.display.toggle = 'block';
                  }
                </script>
