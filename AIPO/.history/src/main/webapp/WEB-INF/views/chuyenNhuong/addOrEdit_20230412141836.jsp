...
<html lang="en">
  ...
  <body>
    ...
    <main class="container">
      ...
      <section  class="row">
       <div class="col  mt-4">
        <form:form action="${pageContext.request.contextPath}/admin/products/saveOrUpdate" modelAttribute="product"  method="post">
          <div class="card">
              ...
              <div class="row">
                <div class="col-md-7">
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" path="productId" id="productId" aria-describedby="productId" placeholder="productId" />
                  ...
                  <div class="form-group">
                    ...
                    <form:select class="form-control" path="category.categoryId" id="categoryId">
