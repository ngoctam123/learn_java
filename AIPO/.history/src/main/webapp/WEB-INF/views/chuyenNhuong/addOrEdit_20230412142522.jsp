              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <div class="form-group">
                    ...
                    <form:select class="form-control" path="category.idCauThu" id="idCauThu">
                    	<form:options items="${cauThus }" itemValue="idCauThu" itemLabel="name"  />
                    	<%-- <c:forEach items="${categories }" var="category">
                    		 <option ${category.idCauThu == product.category.idCauThu ? 'selected': '' } value="${category.idCauThu }">${category.name }</option>
                    	</c:forEach> --%>
