...
<html lang="en">
  ...
  <body>
    ...
    <main class="container">
      ...
      <section  class="row">
       <div class="col  mt-4">
        <form:form action="${pageContext.request.contextPath}/chuyenNhuong/saveOrUpdate" onsubmit="event.preventDefault(); validate()" modelAttribute="chuyenNhuong"  method="post">
          <div class="card">
