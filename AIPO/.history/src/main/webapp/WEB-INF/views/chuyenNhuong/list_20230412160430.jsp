                  ...
                  <tbody>
                    <c:forEach items="${chuyenNhuongs }" var="chuyenNhuong" varStatus="loop">
                      <tr>
                        ...
                        <td>${chuyenNhuong.cauThu.ngaySinh}</td>
                        <td>${chuyenNhuong.cauThu.chieuCao}</td>
                        <td>${chuyenNhuong.cauThu.canNang}</td>
                        <td>${chuyenNhuong.cauLacBo.tenCLB}</td>
                        <td>${chuyenNhuong.thoiGianChuyenNhuong}</td>
                        <td>${chuyenNhuong.tienChuyenNhuong}</td>
