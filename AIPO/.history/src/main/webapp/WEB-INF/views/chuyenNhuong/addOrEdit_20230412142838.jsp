            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-7">
                  ...
                  <div class="form-group">
                    <label for="tienChuyenNhuong">Số tiền chuyển nhượng:</label>
                    <form:input type="text" class="form-control" path="tienChuyenNhuong"  id="tienChuyenNhuong" aria-describedby="tienChuyenNhuongId" placeholder="tienChuyenNhuong" />
                   	<form:errors class="errors" path="tienChuyenNhuong" />
                    <small id="tienChuyenNhuongId" class="form-text text-muted">tienChuyenNhuong is required</small>
                  </div>
                  <div class="form-group">
