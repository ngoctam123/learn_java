                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="my-3 d-flex">
                                        ...
                                        <a name="search" id="search" class=" ms-2 btn btn-outline-secondary text-black" href="${pageContext.request.contextPath}/user/list?searchSelectBox="
                    ...
                    ">
                                    ...
                                    <tbody class="table-group-divider">
                                    	...
                                    	<tr class="table-light">
                                            ...
                                            <td>
                                            	<c:forEach items="${user.company.posts }" var="post">
                                            		${post.postName } ,
                                            	</c:forEach>
                                            	</td>
                                            <td></td>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <div class="row border border-secondary py-3 bg-outlook">
                                                                ...
                                                                <div class="col-md-6">
															        ...
															        <c:forEach var="post" items="${postes}">
