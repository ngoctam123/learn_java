                ...
                <div class="container-fluid">
                    ...
                    ">
                                    <thead class="table-light">
                                        <tr>
                                            <th><input type="checkbox" name="checkboxAll" id="checkboxAll" onchange="handleCheckAll()"></th>
                                            <th>State</th>
                                            <th>User name</th>
                                            <th>name</th>
                                    ...
                                    <tbody class="table-group-divider">
                                    	...
                                    	<tr class="table-light">
                                            <td scope="row"><input type="checkbox" name="checkBoxItem" id="checkBoxItem"></td>
