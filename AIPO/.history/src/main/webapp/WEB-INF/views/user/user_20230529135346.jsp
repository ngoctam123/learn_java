                ...
                <div class="container-fluid">
                    ...
                    ">
                                    ...
                                    <tbody class="table-group-divider">
                                    	...
                                    	<tr class="table-light" name="trBody">
                                            <td scope="row"><input type="checkbox" id="${ user.userId}" name="checkBoxItem" onchange="handleCheckItem(event)"></td>
                            ...
                            <div class="row">
                                <a name="btnRemove" id="btnRemove" class="btn btn-outline-secondary text-black col-md-1 ms-2" 
                                    role="button" >Remove</a>
