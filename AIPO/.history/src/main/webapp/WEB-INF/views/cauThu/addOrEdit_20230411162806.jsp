    ...
    <main class="container">
        ...
        <section  class="row">
         <div class="col-md-6 offset-md-3 mt-4">
            <form:form action="${pageContext.request.contextPath}/admin/accounts/saveOrUpdate" modelAttribute="account" method="post">
                <div class="card">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" path="username" id="username" aria-describedby="usernameId" placeholder="username"/>
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="password" class="form-control" path="password" id="password" aria-describedby="passwordId" placeholder="password"/>
                    ...
                    <div class="card-footer text-muted">
                      ...
                      <a href="${pageContext.request.contextPath}/admin/accounts" class="btn btn-success">List category</a>
