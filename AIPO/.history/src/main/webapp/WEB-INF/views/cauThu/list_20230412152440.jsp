          ...
          <div class="col  mt-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div>
                  <a href="${pageContext.request.contextPath}/cauThu/add"
                    class="btn btn-outline-primary my-2 float-right">Add new cầu thủ</a>
                </div>
                <table class="table table-striped table-inverse table-responsive-md">
                  ...
                  <tbody>
                    <c:forEach items="${cauThus }" var="cauThu" varStatus="loop">
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="${pageContext.request.contextPath}/cauThu/edit/${cauThu.idCauThu}"
                            class="btn btn-outline-warning"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          <a onclick="showConfirmModalDialog(${cauThu.idCauThu}, '${cauThu.tenCauThu}')" data-bs-toggle="modal" data-bs-target="#confirmationId"class="btn btn-outline-danger"><i
