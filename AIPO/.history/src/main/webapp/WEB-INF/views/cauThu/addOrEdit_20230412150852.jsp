            ...
            <form:form action="${pageContext.request.contextPath}/cauThu/saveOrUpdate" modelAttribute="cauThu" method="post">
                <div class="card">
                    ...
                    <div class="input-group form-group">
                      ...
                      <form:input type="number" path="minChuyenNhuong" id="minChuyenNhuong" class="form-control" placeholder="Unit Price"/>
                      <span class="input-group-text">VND</span>
                     </div>

                     <div class="input-group form-group">
                      <span class="input-group-text">Lương:</span>
                      <form:input type="number" path="luong" id="luong" class="form-control" placeholder="Unit Price"/>
                      <span class="input-group-text">VND</span>
                     </div>
