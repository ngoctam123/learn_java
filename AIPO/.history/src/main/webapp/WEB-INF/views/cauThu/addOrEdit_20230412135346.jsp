    ...
    <main class="container">
        ...
        <section  class="row">
         <div class="col-md-6 offset-md-3 mt-4">
            <form:form action="${pageContext.request.contextPath}/cauThu/saveOrUpdate" modelAttribute="category" method="post">
                <div class="card">
                    ...
                    <div class="card-body">
                     <div class="form-group">
                       ...
                       <form:input type="text" class="form-control" path="categoryId" id="categoryId" aria-describedby="categoryId"  placeholder="category id" readonly="true" />
                      	<form:errors class="errors" path="categoryId" />
