                    ...
                    <c:forEach items="${cauLacBos }" var="cauLacBo" varStatus="loop">
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="${pageContext.request.contextPath}/cauLacBo/edit/${cauLacBo.idCLB}"
                            class="btn btn-outline-warning"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          <a onclick="showConfirmModalDialog(${cauLacBo.idCLB}, '${cauLacBo.tenCLB}')" data-bs-toggle="modal" data-bs-target="#confirmationId"class="btn btn-outline-danger"><i
