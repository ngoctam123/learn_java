          ...
          <div class="col  mt-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div>
                  <a href="${pageContext.request.contextPath}/cauLacBoadd"
                    class="btn btn-outline-primary my-2 float-right">Add new cau lac bo</a>
                </div>
                <table class="table table-striped table-inverse table-responsive-md">
                  ...
                  <tbody>
                    <c:forEach items="${cauLacBos }" var="cauLacBo" varStatus="loop">
                      <tr>
                        <td><input type="checkbox" name="" class="form-check-inline" id=" "></td>
                        
                        <td>${cauLacBo.tenCLB}</td>
                        <td>${cauLacBo.sanBong}</td>
                        <td>${cauLacBo.tienQuy}</td>
                        ...
                        <td>
                          ...
                          <a href="${pageContext.request.contextPath}/cauLacBo/edit/${product.productId}"
                            class="btn btn-outline-warning"><i class="fa fa-edit" aria-hidden="true"></i></a>
                          <a onclick="showConfirmModalDialog(${product.productId}, '${product.name}')" data-bs-toggle="modal" data-bs-target="#confirmationId"class="btn btn-outline-danger"><i
                ...
                <script>
                  const showConfirmModalDialog = (id, name) => {
                    ...
                    yesOption.setAttribute('href', `${pageContext.request.contextPath}/admin/products/delete/`+id)
